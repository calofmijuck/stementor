...
하지만 점근적 분석을 할 때는 **계수도 무시하고, 증가율에 가장 큰 영향을 미치는 항만 따지기 때문**에 이런 세세한 부분까지는 고려하지 않아도 됩니다. 일반적으로 `for` 문을 실행하기 위한 연산보다 `for` 문 안에서 실행되는 연산이 훨씬 많습니다. 그러므로 (3)의 연산 수는 대략 $n$ 회라고 생각해도 무방합니다.<sup><a id="fn-3-ref" href="#fn-3">[3]</a></sup><sup><a id="fn-4-ref" href="#fn-4">[4]</a></sup>
